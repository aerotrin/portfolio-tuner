...
from src.presentation.settings import DEFAULT_TRADING_FEE, TRADE_SIZING_GUIDE
from src.services.streamlit_data import create_transaction, load_single_security_quote
from src.shared.dto import Currency, TransactionCreate, TransactionKind
...
def transaction_form(
    ...
    create_transaction(account, payload)
    st.cache_data.clear()
    st.rerun()
