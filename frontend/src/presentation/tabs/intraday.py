...
from src.presentation.widgets.allocation_charts import render_portfolio_allocation
from src.presentation.widgets.kpis import render_health_bar, render_portfolio_kpis
from src.presentation.widgets.transaction_form import transaction_form
from src.presentation.widgets.treemaps import (
...
def render_portfolio_intraday(
    ...
    if holdings is None:
        ...
        _render_transaction_button(account_number, account_name, holdings, fx_rate)
        return
