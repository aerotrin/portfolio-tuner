...
from src.domain.entities.security import GlobalRates
...
async def import_account(
    ...
    """Import transactions from an uploaded xlsx file. Must contain a sheet with a name that matches account_number."""
    ...
    try:
        ...
        account_man.import_account(account_number, file_bytes)
        return  # 202 Accepted
    except Exception as e:
        _raise_http_error(e)
...
# ---------------------------------------------------------------------------
@router.get(
    "/admin/refresh-securities/{job_id}",
